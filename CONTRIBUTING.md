...
- Ensure all CI checks pass. The merge button only enables after `CI / build`, `CI / semantic-pull-request`, and the full regression gates are green.
