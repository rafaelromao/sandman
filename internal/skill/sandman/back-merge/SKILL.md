...
2. Check `git status --short`. If the worktree is dirty, preserve it, inspect the status and diff, record the exact blocker and next executable action in the task board or run log, and return without merging.
