---
name: sandman-tdd
description: Test-driven development with red-green-refactor loop. Use when user says sandman tdd, wants to build features or fix bugs using TDD, mentions "red-green-refactor", wants integration tests, or asks for test-first development.
---
