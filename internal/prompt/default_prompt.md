...
- Whether `.sandman/handoff.md` was written (the file now carries `## Source Prompt`, `## Last Skill`, and `## Last Skill Status` as structured fields per [ADR-0023](../../docs/adr/0023-handoff-points-to-rendered-prompt-and-captures-last-skill.md)).
