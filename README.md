...
- An AI coding agent such as [opencode](https://github.com/opencode-ai/opencode), [Claude Code](https://docs.anthropic.com/en/docs/agents/claude-code), [Codex](https://github.com/openai/codex), or [Pi](https://pi.ai/)
