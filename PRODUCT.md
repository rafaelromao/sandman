...
Pragmatic, sharp, calm. It should feel reliable, technical, and in control, with no fluff or theatrical UI moves.

## Anti-references

- Generic SaaS dashboards with floating KPI cards and decorative chrome
- Flashy AI product pages that feel noisy, speculative, or overbranded
- Card-grid UIs that repeat the same panel shape everywhere
- Modal-heavy flows for routine inspection tasks
- Dark neon, crypto-adjacent visuals, or anything that reads as novelty-first
...
- Keep the portal mobile-friendly, with layouts that remain usable and readable on smaller screens.

## Accessibility & Inclusion

WCAG AA baseline. Support keyboard navigation, clear focus states, sufficient contrast, reduced-motion awareness, readable dense data views for long sessions, and responsive behavior that works well on mobile devices.
