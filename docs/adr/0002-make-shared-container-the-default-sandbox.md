...
> Historical note: this ADR records the accepted decision at the time it was made. For current user-facing vocabulary, treat references to shared-container and isolated-container modes as superseded by the capacity-based model accepted in ADR-0005.
