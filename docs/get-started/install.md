...
Sandman auto-detects repo hints and defaults to the matching preset when it finds .NET, Go, Node, Python, Rust, Elixir, or Ruby project files; otherwise it falls back to `generic`.
