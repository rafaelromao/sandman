...
- Fix: portal review verdict now surfaces 'Approved' / 'Changes requested' for reviews posted via `gh pr comment --body "..."` instead of defaulting to 'Unclear' (follow-up to #1729).
